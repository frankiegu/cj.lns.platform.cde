...
@CjService(name = "importsParallelsCommand")
public class ImportsParallelsCommand2 extends Command {
	...
	public void doCommand(CmdLine cl) throws IOException {
		...
		factory.importsParallelsFromFile(name);
	}

	@Override
	public String cmdDesc() {
		return "导入平行分类：importpara filepath";
	}
