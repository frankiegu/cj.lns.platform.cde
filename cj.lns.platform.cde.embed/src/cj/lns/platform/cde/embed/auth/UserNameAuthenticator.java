...
@CjService(name = "userNameAuthenticator")
public class UserNameAuthenticator implements IAuthenticator {
	@Override
	...
	public AuthResult authenticate(AuthContext ctx, IPin out) throws CircuitException {
		...
		Frame frame = new Frame(
				String.format("authUserCode /serviceOS/public/auth/?account=%s&password=%s&cjtoken=%s sos/1.0",
